        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, i) => (
            ...
            >
              <TiltCard
                intensity={5}
                className="group relative overflow-hidden rounded-2xl border border-fg/10 bg-fg/[0.03] backdrop-blur-md transition-all duration-500 hover:border-gold-300/40"
              >
                {/* Visual */}
